...
class MergeReadinessSmokeTest(unittest.TestCase):
    ...
    def test_kr_noop_market_closed_reason_smoke(self) -> None:
        self.fixture.market.market_open = False
        self._insert_candidate_prediction(
            symbol="005930.KS",
            asset_type=self.fixture.kr_asset_type,
            timeframe="1d",
            scan_id="scan-kr-market-closed",
        )

        entered = entry_decision_job(self.fixture.context, [self.fixture.kr_asset_type])
        dashboard_data = self._load_dashboard_data_for_kis()

        self.assertEqual(entered[self.fixture.kr_asset_type], 0)
        self._assert_event_reason(event_type="noop", reason="market_closed")
        self.assertGreaterEqual(dashboard_data["execution_summary"]["today_noop_count"], 1)

    def test_kr_noop_outside_preclose_reason_smoke(self) -> None:
        self.fixture.market.pre_close = False
        self._insert_candidate_prediction(
            symbol="005930.KS",
            asset_type=self.fixture.kr_asset_type,
            timeframe="1d",
            scan_id="scan-kr-not-preclose",
        )
    ...
    def test_kr_insufficient_buying_power_reason_smoke(self) -> None:
        self.fixture.client.buying_power = {"cash_buy_qty": 0, "max_buy_qty": 0, "cash_buy_amount": 0.0}
        self._insert_candidate_prediction(
            symbol="005930.KS",
            asset_type=self.fixture.kr_asset_type,
            timeframe="1d",
            scan_id="scan-kr-low-buying-power",
        )
        ...
        self.assertGreaterEqual(dashboard_data["execution_summary"]["today_entry_rejected_count"], 1)

    def test_kr_duplicate_pending_entry_reason_smoke(self) -> None:
        ...
        self._insert_candidate_prediction(
            ...
            asset_type=self.fixture.kr_asset_type,
            timeframe="1d",
            scan_id="scan-kr-duplicate-pending",
        )
    ...
    def test_kr_cooldown_active_reason_smoke(self) -> None:
    ...
    def test_kr_no_quote_reason_smoke(self) -> None:
        self.fixture.client.quote_available = False
        self._insert_candidate_prediction(
            symbol="005930.KS",
            asset_type=self.fixture.kr_asset_type,
            timeframe="1d",
            scan_id="scan-kr-no-quote",
        )
