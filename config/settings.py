...
class RuntimeSettings:
    ...
    us_default_strategy_id: str = "us_intraday_1h_v1"
    kr_strategies: Dict[str, KRStrategyConfig] = field(
        default_factory=lambda: {
            ...
            "kr_intraday_15m_v1_auto": KRStrategyConfig(
                strategy_id="kr_intraday_15m_v1_auto",
                strategy_family="kr_intraday_15m",
                display_name="KR 15분봉 정규장+시간외 v1",
                enabled=False,
                experimental=True,
                execution_account_id="kis_kr_paper",
                session_mode="regular",
            ...
            # ── KR Combo v1: 1h 장중 + 15m 시간외종가 세트 (같이 활성화해서 사용) ──
            "kr_combo_1h_ahc_regular_v1": KRStrategyConfig(
                strategy_id="kr_combo_1h_ahc_regular_v1",
                strategy_family="kr_combo_1h_ahc",
                display_name="KR 1h+AHC Combo v1 · Regular",
                enabled=False,
                experimental=True,
                execution_account_id="kis_kr_paper",
                session_mode="regular",
            ...
            "kr_combo_1h_ahc_afterclose_v1": KRStrategyConfig(
                strategy_id="kr_combo_1h_ahc_afterclose_v1",
                strategy_family="kr_combo_1h_ahc",
                display_name="KR 1h+AHC Combo v1 · After-close",
                enabled=False,
                experimental=True,
                execution_account_id="kis_kr_paper",
                session_mode="after_close_close_price",
            ...
            # ── US 전략: sim_us_equity 계좌, ET 기준 (asset_schedule_key="미국주식") ──
            "us_intraday_1h_v1": KRStrategyConfig(
                strategy_id="us_intraday_1h_v1",
                strategy_family="us_intraday",
                display_name="US Intraday 1h v1",
                enabled=False,
                experimental=True,
                execution_account_id="sim_us_equity",
                session_mode="regular",
                order_division="00",
                session_price_policy="market_best_effort",
                auction_interval_minutes=0,
                ...
                min_signal_strength_pct=0.14,
                min_expected_return_pct=0.20,
                min_confidence=0.54,
                max_expected_risk_pct=2.5,
                max_cost_bps=12.0,
                score_decay_exit_threshold=0.18,
                trailing_stop_atr_mult=0.9,
                stop_loss_atr_mult=1.0,
                ...
                flatten_window_start="15:45",
                flatten_window_end="16:00",
                max_daily_new_entries=4,
                cooldown_bars_after_exit=1,
                asset_schedule_key="미국주식",
            ),
            "us_afterhours_v1": KRStrategyConfig(
                strategy_id="us_afterhours_v1",
                strategy_family="us_afterhours",
                display_name="US After Hours v1",
                enabled=False,
                experimental=True,
                execution_account_id="sim_us_equity",
                session_mode="after_close_close_price",
            ...
            # ── US Combo v1 (1h regular + after-hours) family ──
            "us_combo_1h_ahc_regular_v1": KRStrategyConfig(
                strategy_id="us_combo_1h_ahc_regular_v1",
                strategy_family="us_combo_1h_ahc",
                display_name="US 1h+AH Combo v1 · Regular",
                enabled=False,
                experimental=True,
                execution_account_id="sim_us_equity",
                session_mode="regular",
            ...
            "us_combo_1h_ahc_afterhours_v1": KRStrategyConfig(
                strategy_id="us_combo_1h_ahc_afterhours_v1",
                strategy_family="us_combo_1h_ahc",
                display_name="US 1h+AH Combo v1 · After-hours",
                enabled=False,
                experimental=True,
                execution_account_id="sim_us_equity",
                session_mode="after_close_close_price",
            ...
            # ── KR Combo v2 (15m regular + after-close) family ──
            "kr_combo_15m_ahc_regular_v2": KRStrategyConfig(
                strategy_id="kr_combo_15m_ahc_regular_v2",
                strategy_family="kr_combo_15m_ahc",
                display_name="KR 15m+AHC Combo v2 · Regular",
                enabled=False,
                experimental=True,
                execution_account_id="kis_kr_paper",
                session_mode="regular",
            ...
            "kr_combo_15m_ahc_afterclose_v2": KRStrategyConfig(
                strategy_id="kr_combo_15m_ahc_afterclose_v2",
                strategy_family="kr_combo_15m_ahc",
                display_name="KR 15m+AHC Combo v2 · After-close",
                enabled=False,
                experimental=True,
                execution_account_id="kis_kr_paper",
                session_mode="after_close_close_price",
            ...
            # ── US Combo v2 (15m regular + after-hours) family ──
            "us_combo_15m_ahc_regular_v1": KRStrategyConfig(
                strategy_id="us_combo_15m_ahc_regular_v1",
                strategy_family="us_combo_15m_ahc",
                display_name="US 15m+AH Combo v2 · Regular",
                enabled=False,
                experimental=True,
                execution_account_id="sim_us_equity",
                session_mode="regular",
            ...
            "us_combo_15m_ahc_afterhours_v1": KRStrategyConfig(
                strategy_id="us_combo_15m_ahc_afterhours_v1",
                strategy_family="us_combo_15m_ahc",
                display_name="US 15m+AH Combo v2 · After-hours",
                enabled=False,
                experimental=True,
                execution_account_id="sim_us_equity",
                session_mode="after_close_close_price",
